...
RUN \
	curl -sL https://dl.google.com/go/go1.11.4.linux-386.tar.gz | \
	tar -zx -C /usr/local
...
# libsndfile http://www.mega-nerd.com/libsndfile/
        ...
        ./configure --host=i686-pc-linux-gnu --prefix="${SRC}" --disable-sqlite --disable-alsa --disable-external-libs --disable-octave && \
        make -j2 && \
        make install && \
        rm -rf ${DIR}
...
# pulseaudio https://www.freedesktop.org/wiki/Software/PulseAudio/
        ...
        ./configure --host=i686-pc-linux-gnu --prefix="${SRC}" --disable-x11 --disable-tests --disable-oss-wrapper \
